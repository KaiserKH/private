...
userRouter.patch("/me", requireAuth, validate({ body: z.object({ displayName: z.string().optional(), bio: z.string().optional(), profilePhotoUrl: z.string().url().optional(), wallpaperUrl: z.string().url().optional() }) }), asyncHandler(async (req, res) => {
